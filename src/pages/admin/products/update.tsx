...
import { useChangeImage } from "@/hooks/query-products/useChangeImages";

import { useDeleteExtraImages } from "@/hooks/query-products/useDeleteExtraImages";
import { useFormCreateProduct } from "@/hooks/query-products/useFormCreateProducts";
          ...
          <div className="w-1/2 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              <Input
                ...
                multiple
              />
              <ScrollArea className="h-[300px] w-full border overflow-x-auto">
